    ...
    <div class="container-fluid">
        <div class="card shadow p-4 table-container">
            <div class="d-flex justify-content-between mb-3 align-items-center">
                <h4 class="mb-0">Shared Files List</h4>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{$file->fn}} {{$file->ln}}</td>
                            <td class="text-center">{{ $file->available_from }}</td>
                            <td class="text-center">{{ $file->available_until }}</td>
                            <td class="text-center">{{ $file->accepted_at }}</td>
...
<script>
    ...
    function uploadFile() {
        ...
        formData.append("innerchild_id", document.getElementById("innerchildId").value);
        formData.append("last_id", document.getElementById("lastId").value);
        ...
        axios.post("{{ route('admin.files.last_file_upload') }}", formData, {
    ...
    document.querySelectorAll('.delete-btn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.post(`{{ route('admin.files.last_file_delete') }}`, {
                        id: fileId,
                        _token: '{{ csrf_token() }}'
                    })
                    .then(response => {
