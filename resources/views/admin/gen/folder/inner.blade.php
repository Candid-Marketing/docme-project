    ...
    @endif
        ...
        <ul class="list-group folder-list">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center" data-folder-id="{{ $folder->id }}">
                    <a href="#" class="folder-link" onclick="submitFolder('{{$main_id}}','{{$id_main}}','{{ $folder->id }}', '{{ $folder->inner_folder_name }}')">
        ...
        <form id="folderForm" action="{{ route('admin.childfolders.show') }}" method="POST" style="display: none;">
            @csrf
