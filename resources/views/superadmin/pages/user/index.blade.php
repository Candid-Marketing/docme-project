        ...
        <div class="card shadow p-4 table-container">
            ...
            <div class="mb-3 d-flex justify-content-left">
                <div class="input-group" style="max-width: 300px;">
                    ...
                    <input type="text" id="searchInput" class="form-control" placeholder="Search users..." style="border-radius: 6px;">
                </div>
            </div>
...
<script>
   ...
   function submitUser() {
        ...
        axios.post("{{ route('superadmin.add-user') }}", {
    ...
    document.querySelectorAll(".edit-btn").forEach(button => {
        ...
        document.querySelector(".saveButton").addEventListener("click", function () {
            ...
            axios.post("{{route('superadmin.edit-user')}}", {
                user_id: userId,
            ...
            .then(response => {
                ...
                let button = document.querySelector(`button[data-id='${userId}']`);
                ...
                userStatus == 1 ? "Admin" : (userStatus == 2 ? "User" : "Guest");
        ...
        document.getElementById("confirmDelete").addEventListener("click", function () {
            ...
            axios.post("{{route('superadmin.delete-user')}}", {
        ...
        document.getElementById("searchInput").addEventListener("keyup", function () {
            ...
            if (query.length > 0) {
                axios.get("{{ route('superadmin.search-user') }}", { params: { query: query } })
                    .then(response => {
