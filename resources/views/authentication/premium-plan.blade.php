      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
        <div class="pricing-card">
          ...
          <div class="price">
            ...
            <span class="amount">{!! nl2br(e($homepage->where('name', 'price_year')->first()->content ?? '1.00')) !!}</span>
            <span class="period">/ day</span>
          </div>
          <p class="description">{!! nl2br(e($homepage->where('name', 'price_desc3')->first()->content ?? 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam.')) !!}</p>
          <h4>Featured Included:</h4>
          <ul class="features-list">
            <li><i class="bi bi-check-circle-fill"></i> {!! nl2br(e($homepage->where('name', 'include_state3')->first()->content ?? 'Duis aute irure dolor')) !!}</li>
            <li><i class="bi bi-check-circle-fill"></i> {!! nl2br(e($homepage->where('name', 'include_state6')->first()->content ?? ' Excepteur sint occaecat')) !!}</li>
            <li><i class="bi bi-check-circle-fill"></i> {!! nl2br(e($homepage->where('name', 'include_state9')->first()->content ?? ' Nemo enim ipsam voluptatem')) !!}</li>
            <li><i class="bi bi-check-circle-fill"></i> {!! nl2br(e($homepage->where('name', 'include_state12')->first()->content ?? ' Nemo enim ipsam voluptatem')) !!}</li>
          </ul>
         ...
         <button
            ...
            data-amount="{{ $homepage->where('name', 'price_year')->first()->content ?? '1.00' }}"
