...
<body>
  ...
  <div class="card">
    <div class="header">
      <h2>DocME</h2>
      <p>Folder Invitation Notification</p>
    </div>

    <div class="content-box">
      <p>Hello,</p>

      <p>You've been invited to access a folder by <strong>{{ $invitation->inviter->first_name }} {{ $invitation->inviter->last_name }}</strong>.</p>
      ...
      <p>Please log in or register to view the folder using your secure access.</p>
